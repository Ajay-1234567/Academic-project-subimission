...
function createEmailTemplate(content, buttonText, buttonUrl) {
    ...
    <head>
        ...
        <style>
            ...
            .header { background: #ffffff; padding: 24px 40px; text-align: left; border-bottom: 1px solid #e2e8f0; }
            .header h1 { color: #1e293b; margin: 0; font-size: 22px; font-weight: 700; letter-spacing: -0.5px; display: inline-block; vertical-align: middle; }
            .header img { display: inline-block; vertical-align: middle; margin-right: 15px; border-radius: 8px; }
    ...
    <body>
        <div class="container">
            <div class="header">
                <img src="https://academic-project-subimission.vercel.app/logo.png" width="50" height="50" alt="EduPortal Logo">
                <h1>EduPortal</h1>
            </div>
            <div class="content">
                ${content}
