...
@Component({
  ...
  styles: [`
    ...
    * { font-family: 'Inter', sans-serif; box-sizing: border-box; }
    ...
    .header-time { font-size: 0.85rem; color: #94a3b8; font-weight: 500; background: white; border: 1px solid #e2e8f0; padding: 0.4rem 1rem; border-radius: 8px; }

    .stats-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 1.5rem; margin-bottom: 2.5rem; }
    .stat-card { background: white; border-radius: 16px; padding: 1.8rem 2rem; display: flex; justify-content: space-between; align-items: center; border: 1px solid #e2e8f0; box-shadow: 0 2px 8px rgba(0,0,0,0.04); transition: all 0.25s; }
    ...
    .action-card { display: flex; align-items: center; gap: 1rem; background: white; border: 1px solid #e2e8f0; border-radius: 14px; padding: 1.4rem 1.5rem; text-decoration: none; color: inherit; transition: all 0.25s; }
    ...
    .faculty-overview-card { background: white; border: 1px solid #e2e8f0; border-radius: 14px; padding: 1.5rem; transition: all 0.25s; }
    ...
    .foc-info h4 { margin: 0; font-size: 1rem; font-weight: 700; color: #1e293b; }
    .foc-email { font-size: 0.78rem; color: #64748b; }
    .foc-stats { display: flex; gap: 0.75rem; margin-bottom: 1rem; }
    .foc-stat { flex: 1; text-align: center; background: #f8fafc; border-radius: 8px; padding: 0.6rem 0.5rem; }
    .foc-stat.submitted { background: #ecfdf5; }
    .foc-stat.pending { background: #fffbeb; }
    .foc-num { display: block; font-size: 1.4rem; font-weight: 700; color: #1e293b; }
    .foc-stat.submitted .foc-num { color: #059669; }
    .foc-stat.pending .foc-num { color: #d97706; }
    .foc-lbl { font-size: 0.68rem; color: #94a3b8; text-transform: uppercase; font-weight: 600; letter-spacing: 0.5px; }
    ...
    /* Activity */
    .activity-section { }
    .activity-card { background: white; border: 1px solid #e2e8f0; border-radius: 14px; overflow: hidden; }
    ...
    .empty-activity { text-align: center; padding: 4rem 2rem; background: white; border-radius: 14px; border: 1px dashed #cbd5e1; color: #94a3b8; }
