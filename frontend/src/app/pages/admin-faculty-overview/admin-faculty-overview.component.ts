...
@Component({
  ...
  styles: [`
    ...
    * { font-family: 'Inter', sans-serif; box-sizing: border-box; }
    ...
    .back-btn { background: var(--surface); border: 1px solid var(--border); border-radius: 8px; padding: 0.5rem 1.2rem; color: #475569; text-decoration: none; font-weight: 500; font-size: 0.9rem; transition: all 0.2s; white-space: nowrap; }
    .back-btn:hover { background: #f1f5f9; color: var(--text-primary); border-color: var(--text-secondary); }

    .header-actions { display: flex; align-items: center; gap: 1rem; }
    .admin-search-wrap { position: relative; min-width: 250px; }
    .admin-search-wrap .search-icon { position: absolute; left: 10px; top: 50%; transform: translateY(-50%); color: var(--text-secondary); font-size: 0.9rem; }
    .admin-search-input { width: 100%; padding: 0.5rem 1rem 0.5rem 2.2rem; border-radius: 8px; border: 1px solid var(--border); background: var(--surface); font-size: 0.9rem; }
    .admin-search-input:focus { outline: none; border-color: #6366f1; box-shadow: 0 0 0 3px rgba(99,102,241,0.1); }

    /* Loading / Empty */
    .loading-state { display: flex; align-items: center; gap: 1rem; color: var(--text-secondary); padding: 3rem; background: var(--surface); border-radius: 12px; border: 1px solid var(--border); }
    .spinner { width: 24px; height: 24px; border: 3px solid var(--border); border-top-color: #6366f1; border-radius: 50%; animation: spin 0.8s linear infinite; flex-shrink: 0; }
    @keyframes spin { to { transform: rotate(360deg); } }
    .empty-state { text-align: center; padding: 4rem; background: var(--surface); border-radius: 12px; border: 1px dashed var(--border); color: var(--text-secondary); }
    ...
    .faculty-section { background: var(--surface); border-radius: 16px; border: 1px solid var(--border); overflow: hidden; margin-bottom: 2rem; box-shadow: 0 2px 8px rgba(0,0,0,0.04); }

    /* Faculty Header */
    .faculty-header { display: flex; align-items: center; gap: 1.25rem; padding: 1.5rem 2rem; background: linear-gradient(135deg, #f8fafc, #eff6ff); border-bottom: 1px solid var(--border); flex-wrap: wrap; }
    ...
    .faculty-info h2 { margin: 0 0 0.2rem; font-size: 1.2rem; font-weight: 700; color: var(--text-primary); }
    .faculty-email { font-size: 0.82rem; color: var(--text-secondary); }
    ...
    .badge.pending { background: var(--surface)beb; color: #d97706; }
    ...
    .fac-btn.outline { background: var(--surface); border: 1px solid var(--border); color: #475569; }
    .fac-btn.outline:hover { background: #f1f5f9; color: var(--text-primary); border-color: var(--text-secondary); }

    /* Progress */
    .progress-row { display: flex; align-items: center; gap: 1rem; padding: 1rem 2rem; border-bottom: 1px solid #f1f5f9; }
    .progress-label { font-size: 0.78rem; font-weight: 700; color: var(--text-secondary); text-transform: uppercase; letter-spacing: 0.5px; white-space: nowrap; }
    ...
    .progress-pct { font-size: 0.85rem; font-weight: 700; color: var(--text-primary); min-width: 40px; text-align: right; }
    ...
    .table-filter-row button:hover:not(.act) { background: var(--border); color: var(--text-primary); }

    /* Table */
    .students-table-wrap { overflow-x: auto; }
    .students-table { width: 100%; border-collapse: collapse; font-size: 0.88rem; }
    .students-table th { padding: 0.85rem 1rem; text-align: left; font-size: 0.73rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.6px; color: var(--text-secondary); background: var(--background); border-bottom: 2px solid var(--border); white-space: nowrap; }
    ...
    .submitted-row td { }
    .pending-row td { background: var(--surface)df5; }
    .pending-row:hover td { background: #fef9e7 !important; }
    .expanded-row td { background: #f0f4ff !important; border-bottom: none; }
    .row-num { color: var(--text-secondary); font-size: 0.78rem; font-family: monospace; width: 30px; }
    ...
    .student-name { font-weight: 600; color: var(--text-primary); font-size: 0.9rem; }
    .email-cell { color: var(--text-secondary); font-size: 0.78rem; }
    .roll-badge { background: #f1f5f9; color: #475569; padding: 0.15rem 0.5rem; border-radius: 4px; font-family: monospace; font-size: 0.8rem; border: 1px solid var(--border); }
    ...
    .count-badge { display: inline-flex; align-items: center; justify-content: center; min-width: 28px; height: 26px; border-radius: 6px; font-size: 0.88rem; font-weight: 700; color: var(--text-secondary); background: #f1f5f9; }
    .count-badge.has-count { color: var(--text-primary); background: #ede9fe; }
    ...
    .status-pill.pend { background: var(--surface)beb; color: #d97706; border: 1px solid #fcd34d; }
    ...
    .send-btn { background: var(--surface)beb; color: #d97706; border: 1px solid #fcd34d; }

    /* Project Expand Panel */
    .project-expand-row td { padding: 0; border-bottom: 1px solid var(--border); background: #f5f8ff; }
    ...
    .expand-title strong { color: var(--text-primary); }
    .expand-subj-scope { font-size: 0.82rem; color: var(--text-secondary); display: flex; align-items: center; gap: 0.35rem; }
    ...
    .proj-loading { color: var(--text-secondary); font-style: italic; font-size: 0.9rem; }
    .no-projects { background: var(--surface)beb; border: 1px solid #fcd34d; border-radius: 8px; padding: 1rem 1.5rem; color: #92400e; font-size: 0.88rem; display: flex; align-items: center; gap: 0.5rem; }

    .projects-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: 1rem; }
    .project-mini-card { background: var(--surface); border: 1px solid var(--border); border-radius: 12px; padding: 1.25rem; transition: all 0.2s; }
    ...
    .pmc-title { flex: 1; font-weight: 700; color: var(--text-primary); font-size: 0.92rem; line-height: 1.4; }
    .pmc-id { font-size: 0.75rem; color: var(--text-secondary); font-family: monospace; flex-shrink: 0; }
    ...
    .score-label { font-size: 0.68rem; color: var(--text-secondary); text-transform: uppercase; font-weight: 600; }
    ...
    .no-results { text-align: center; color: var(--text-secondary); padding: 2.5rem; font-style: italic; }
    .no-students-msg { padding: 1.5rem 2rem; color: var(--text-secondary); font-size: 0.9rem; }
